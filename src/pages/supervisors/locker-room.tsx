...
export default function NewPost() {
  ...
  const saveMeasurement = async () => {
    ...
    const querySnapshot = await getDocs(q);
    if (!querySnapshot.empty) {
      toast.error("A tarefa vestiario já foi feita hoje!");
      setIsLoading(false);
      return;
    }
  ...
  async function sendMessage(data: {
    ...
    const messageBody = `*Limpeza e Organização dos Vestiários*\n\n*Data:* ${formattedDate}\n*Hora:* ${data.time}\n*Posto:* ${data.postName}\n*Supervisor:* ${data.supervisorName}\n\n*Status:* ${status}\n${imagesDescription}\n\n${observationsMsg}`;
      ...
      <div className={styles.Container}>
        <div className={styles.BudgetContainer}>
          <div className={styles.BudgetHead}>
            <p className={styles.BudgetTitle}>Vestiário</p>
          ...
          <p className={styles.Notes}>
            Informe abaixo as informações do vestiário
          </p>
              ...
              {docId &&
                ...
                data?.images.map((image, index) => (
                  <div key={index} className={styles.InputField}>
                    <p className={styles.titleTank}>Limpeza dos vestiários</p>
